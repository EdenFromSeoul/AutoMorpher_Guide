...
category: "시작하기"
description: "Booth에서 きせった (Kisetter) {{VERSION}}을 내려받아 Unity 프로젝트에 설치하고 첫 작업을 준비합니다."
order: 10
---

## 시작하기 전에

きせった (Kisetter)는 Unity Humanoid 아바타용 의상을 다른 아바타 체형에 맞게 변형하는 Unity 에디터 도구입니다. 의상의 본, Mesh, Weight를 자동으로 조정하며 필요한 경우 수동 본 조정과 BlendShape 기반 결과 저장도 지원합니다.

!!! info "현재 문서 버전"
    이 가이드는 **きせった (Kisetter) {{VERSION}}**을 기준으로 작성되었습니다.
...
1. [きせった (Kisetter) Booth 페이지](https://edenlabs.booth.pm/items/7721082)에서 파일을 내려받습니다.
...
6. 다음 경로에 きせった (Kisetter) 파일이 생성되었는지 확인합니다.
