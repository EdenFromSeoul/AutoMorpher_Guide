...
PAGES = [
    PageSpec("ko", "한국어", "의상 자동 대응 가이드", "auto-fitting", "사용 가이드", "의상을 대상 아바타에 맞게 자동으로 변형하고, 필요한 경우 사전 조정과 Mesh 추가 보정을 진행하는 전체 작업 흐름입니다.", 20, "의상 자동 대응 가이드"),
    ...
    PageSpec("ja", "日本語", "衣装自動対応ガイド", "auto-fitting", "使用ガイド", "衣装を対象アバターに合わせて自動変形し、必要に応じて事前調整とMeshの追加補正を行う全体の手順です。", 20, "衣装自動対応ガイド"),
    ...
    PageSpec("en", "English", "Automatic Outfit Fitting Guide", "auto-fitting", "User Guide", "Complete workflow for automatically fitting an outfit to a target avatar, with optional pre-adjustment and additional Mesh editing.", 20, "Automatic Outfit Fitting Guide"),
