...
export const REVIEWS_COPY: Record<Language, ReviewsCopy> = {
  ja: {
    ...
    title: ["きせったを実際に使った方の", "声をご紹介します。"],
    description: "Xに投稿された、きせった（Kisetter）の使用感や衣装対応後の仕上がりをご紹介します。気になるレビューを選ぶと、Xの元投稿をご覧いただけます。",
    countLabel: "Xに投稿されたユーザーレビュー",
    originalNotice: "投稿を選択するとXの元投稿へ移動します。",
    originalLink: "Xで元投稿を見る",
    shopLabel: "BOOTHで販売中",
    shopTitle: "非対応衣装を、あなたのアバターに。",
    shopDescription: "必要なのは、アバターと衣装だけ。\nきせったなら、すぐに衣装対応を始められます。",
